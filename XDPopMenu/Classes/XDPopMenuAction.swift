...
@objc public protocol XDPopMenuAction: NSObjectProtocol {
    ...
    typealias PopMenuActionHandler = (XDPopMenuAction) -> Void
    
}

/// The default PopMenu action class.
public class PopMenuDefaultAction: NSObject, XDPopMenuAction {
