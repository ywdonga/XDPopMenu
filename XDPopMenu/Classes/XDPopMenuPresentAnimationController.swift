...
final public class XDPopMenuPresentAnimationController: NSObject, UIViewControllerAnimatedTransitioning {
    ...
    public func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        guard let menuViewController = transitionContext.viewController(forKey: .to) as? XDPopMenuVC else { return }
    ...
    fileprivate func prepareAnimation(_ viewController: XDPopMenuVC) {
    ...
    /// Run the animation.
    fileprivate func animate(_ viewController: XDPopMenuVC) {
