...
@objc public protocol XDPopMenuVCDelegate: class {
    /// Called when an action is selected.
    @objc optional func popMenuDidSelectItem(_ popMenuVC: XDPopMenuVC, at index: Int)
}

final public class XDPopMenuVC: UIViewController {
    ...
    /// Main content view.
    public let contentView = XDPopMenuGradientView()
    ...
    /// Actions of menu.
    public private(set) var actions: [XDPopMenuAction] = []
    ...
    public convenience init(sourceView: AnyObject? = nil, actions: [XDPopMenuAction], appearance: XDPopMenuAppearance? = nil) {
    ...
    public func addAction(_ action: XDPopMenuAction) {
...
extension XDPopMenuVC: UIViewControllerTransitioningDelegate {
    
    /// Custom presentation animation.
    public func animationController(forPresented presented: UIViewController, presenting: UIViewController, source: UIViewController) -> UIViewControllerAnimatedTransitioning? {
        return XDPopMenuPresentAnimationController(sourceFrame: absoluteSourceFrame)
    }
    
    /// Custom dismissal animation.
    public func animationController(forDismissed dismissed: UIViewController) -> UIViewControllerAnimatedTransitioning? {
        return XDPopMenuDismissAnimationController(sourceFrame: absoluteSourceFrame)
    }
